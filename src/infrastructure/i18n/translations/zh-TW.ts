...
export const zhTWTranslations: TranslationKey = {
  ...
  smartConversion: {
    ...
    enterConversionOptions: '請選擇可用的轉換選項：',
    quickConversion: '自動套用範本',
    quickConversionDescription: '根據內容自動選擇最佳範本',
    autoSelected: '自動選擇',
    smartRecommendations: '智能自定義配置（建議）',
    ...
    intelligentMatching: {
      analysisTitle: '🔍 智能匹配分析:',
      matchingDecisions: '🎯 智能匹配決策:',
      headerConfig: '頁首配置',
      footerConfig: '頁尾配置',
      headerConfiguration: '頁首配置:',
      footerConfiguration: '頁尾配置:',
      noFieldsEnabled: '無啟用欄位',
      headerDisabled: '頁首未啟用',
      footerDisabled: '頁尾未啟用',
      headerNotEnabled: '頁首未啟用',
      footerNotEnabled: '頁尾未啟用',
      detailedAnalysis: '智能匹配詳細分析',
      logPrefix: '智能匹配詳細分析:\n',
      availability: {
        documentTitle: '文檔標題: {{status}} {{reason}}',
        authorInfo: '作者資訊: {{status}} {{reason}}',
        organizationInfo: '組織資訊: {{status}} {{reason}}',
        versionInfo: '版本資訊: {{status}} {{reason}}',
        categoryInfo: '類別資訊: {{status}} {{reason}}',
        copyrightInfo: '版權資訊: {{status}} {{reason}}',
      },
      reasons: {
        available: '✅ 可用',
        notAvailable: '❌ 不可用',
        titleStructureDetected: '(檢測到標題結構)',
        configValueExists: '(設定檔中有值)',
      },
      fieldDecisions: {
        title:
          '標題 (使用者偏好: {{userPreference}}, 文檔內容: {{contentAvailable}})',
        pageNumber:
          '頁碼 (使用者偏好: {{userPreference}}, 總是可用: {{alwaysAvailable}})',
        author:
          '作者 (使用者偏好: {{userPreference}}, 設定檔有值: {{configValue}})',
        organization:
          '組織 (使用者偏好: {{userPreference}}, 設定檔有值: {{configValue}})',
        version:
          '版本 (使用者偏好: {{userPreference}}, 設定檔有值: {{configValue}})',
        category:
          '類別 (使用者偏好: {{userPreference}}, 設定檔有值: {{configValue}})',
      },
      statusIcons: {
        enabled: '✅',
        disabled: '❌',
  ...
  interactive: {
    ...
    // No template mode
    noTemplate: '不使用範本',
    noTemplateDescription: '使用自定義頁首頁尾設定，而非範本預定義的樣式',
    noTemplateMode: '不使用範本模式',
    noTemplateModeDesc: '將使用您的自定義頁首頁尾配置',
    noTemplateUsed: '未選擇範本',
    usingCustomSettings: '使用您的自定義頁首頁尾配置',
    headerStatus: '頁首狀態',
    footerStatus: '頁尾狀態',
    enabled: '已啟用',
    disabled: '已停用',
